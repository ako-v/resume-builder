...
var Experience = function () {
    return ((0, jsx_runtime_1.jsxs)("section", { children: [(0, jsx_runtime_1.jsx)("h3", { className: "section-title", children: "EXPERIENCE" }), (0, jsx_runtime_1.jsx)(ExperiencePart_1.default, { time: "06/2023 - Current", position: "FRONT-END DEVELOPER", company: "Arades GmbH", location: "Offenbach, Germany (Remote)", projects: [
                    {
                        description: "Led the development of a high-performance Front-End application for a business intelligence platform using React, Redux, and MUI.",
                        listItems: [
                    ...
                    {
                        description: "Enhanced a school event management application (ReactJS) for improved usability and performance.",
                        listItems: [
                ...
                ] }), (0, jsx_runtime_1.jsx)(ExperiencePart_1.default, { time: "05/2021 - 06/2023", position: "FRONT-END DEVELOPER", company: "AAICCO", location: "Tehran, Iran", projects: [
                    {
                        description: "Spearheaded the development and maintenance of a state-of-the-art stock broker front-end for trading in Tehran Stock Exchange (TSE) utilizing Typescript, React, Redux, and a customized UI library (MUI and rollup).",
                        listItems: [
                    ...
                    {
                        description: "Proactively maintained and enhanced an asset monitoring solution for Tehran Stock Exchange (TSE) assets.",
                        listItems: [
                ...
                ] }), (0, jsx_runtime_1.jsx)(ExperiencePart_1.default, { time: "02/2019 - 05/2021", position: "FRONT-END DEVELOPER", company: "Freelancer", location: "Tehran, Iran", projects: [
                    {
                        description: "",
                        listItems: [
